...
<!-- INDIVIDUAL CAT-->
    ...
    <div class='individual'>
        <div class='float' id='cat'>
            ...
            <img id='catPic' src="images/Wiwa.jpg" width= "50%"/>
        <div class='ab'>Hello, My name is Wiwa!</div>
            <ul>
                <li><strong>Name: </strong>Wiwa</li>
                <li><strong>Gender: </strong>M</li>
                <li><strong>Age: </strong>11 years 1 month</li>
                <li><strong>Breed: </strong>Domestic Longhair</li>
                <li><strong>Colour: </strong>Grey</li>
                <li><strong>Personality: </strong>Anxious</li>
            </ul>
        </div>
...
<!-- CAT'S STORY -->
        <div class='float' id='story'>
            <h1> Wiwa's Story </h1>
            <p>Wiwa has been through so much in his 11 years of life. He was abandoned by his family and left out in the cold, scared and lonely. Eventually he was brought to Hamilton Animal Services, his face covered in scabs from street cats beating him up. For 2 months, Wiwa waited in a cage hoping for someone to take him home. And then, one of our volunteers saw him.</p>
        </div>
...
<!-- window -->
        ...
        ?> 
            ...
            <h3 id='subject'>Book a Visit!</h3>
                <form class='contact-form' method='POST' action='individual_Wiwa.php'>
                        <div class="form">
