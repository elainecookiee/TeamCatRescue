...
<!-- INDIVIDUAL CAT-->
    ...
    <div class='individual'>
        <div class='float' id='cat'>
            ...
            <img id='catPic' src="images/Matsu.jpeg" width= "50%"/>
        <div class='ab'>Hello, My name is Matsu!</div>
            <ul>
                <li><strong>Name: </strong>Matsu</li>
                <li><strong>Gender: </strong>M</li>
                <li><strong>Age: </strong>7 years 8 months</li>
                <li><strong>Breed: </strong>Persian</li>
                <li><strong>Colour: </strong>Grey</li>
                <li><strong>Personality: </strong>Introverted</li>
            </ul>
        </div>
...
<!-- CAT'S STORY -->
        <div class='float' id='story'>
            <h1> Matsu's Story </h1>
            <p>My name is Matsu! I am 7 years young and such a handsome boy (so my meowmie tells me). I have been with my mom and dad for 8 months now. Mom and dad didn't know whether or not I would be happy living with other animals and unfortunately I'm not. I had 3 siblings and even though they were very nice, I just prefer to be on my own.</p>
        </div>
...
<!-- window -->
        ...
        ?> 
            <h3 id='subject'>Book a Visit!</h3>
                <form class='contact-form' method='POST' action='individual_Matsu.php'>
                        <div class="form">
